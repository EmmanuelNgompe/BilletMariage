import './App.css';
import coverImage from './images/couverture.jpg';
    ...
    <div className="App">
      <div className="bb1" style={{ backgroundImage: `url(${coverImage})` }}>
        <div className="bb2">
          ...
          <button style={{ display: 'flex', position: 'absolute', flexDirection: 'column', justifyContent: 'center', margin: '0 auto', alignItems: 'center', gap: '5px', borderRadius: '26px', backgroundColor: '#193BA2', color: 'rgb(255, 255, 255)', fontWeight: 700, fontSize: '14px', padding: '14px 34px', cursor: 'pointer', boxShadow: 'rgba(75, 17, 65, 0.5) 0px 10px 28px', border: 'none', transition: 'all 0.3s ease 0s' }}>
